    ...
    <div class="block-slider block-slider4">
        <ul class="" id="bxslider-home4">
            <li>
                ...
                <div class="caption-group">
                    <h2 class="caption title">
                        <!-- Collection <span class="primary">1</span> -->
                    </h2>
                    <h4 class="caption subtitle"></h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span><b>Buy</b></a>
                </div>
            </li>
            <li><img src="res/site/img/h4-slide2.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        <!-- Collection <span class="primary">2</span> -->
                    </h2>
                    <h4 class="caption subtitle"></h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span><b>Buy</b></a>
                </div>
            ...
            <li><img src="res/site/img/h4-slide3.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        <!-- Collection <span class="primary">3</span> -->
                    </h2>
                    <h4 class="caption subtitle"></h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span><b>Buy</b></a>
                </div>
            ...
            <li><img src="res/site/img/h4-slide4.png" alt="Slide">
                <div class="caption-group">
                    <h2 class="caption title">
                        <!-- Collection <span class="primary">4</span> -->
                    </h2>
                    <h4 class="caption subtitle"></h4>
                    <a class="caption button-radius" href="#"><span class="icon"></span><b>Buy</b></a>
                </div>
